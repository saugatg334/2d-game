...
const vehicleSpecs = [
  ...
  ['sajha_bus', 'Sajha Bus', 'bus', 220, 80, 250, 2, 3000, 0.8, 0.9, 120, 60, 20, 1.5, 50],
  ['pickup', 'Pickup', 'pickup', 320, 130, 170, 2, 1200, 1.1, 1, 85, 45, 16, 2.8, 500],
  ['mountain_suv', 'Mountain SUV', 'suv', 260, 90, 220, 2, 2000, 1.3, 1.2, 95, 55, 22, 1.8, 100],
  ['himalayan_bike', 'Himalayan Bike', 'motorcycle', 350, 155, 130, 1.5, 220, 1, 1.15, 55, 35, 14, 3.1, 700],
  ['terai_motorbike', 'Terai Motorbike', 'motorcycle', 360, 165, 125, 1.8, 190, 0.9, 1.05, 52, 32, 13, 3.2, 720],
  ['city_scooter', 'City Scooter', 'scooter', 260, 115, 145, 1.4, 170, 0.8, 1.1, 48, 35, 13, 2.8, 350],
  ['dirt_bike', 'Dirt Bike', 'dirt_bike', 330, 145, 140, 1.7, 210, 1.3, 1.2, 58, 38, 15, 3, 760],
  ['rural_tractor', 'Rural Tractor', 'tractor', 180, 70, 230, 3, 2600, 1.4, 1.3, 105, 65, 24, 1.4, 600],
